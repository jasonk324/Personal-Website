            ...
            <img src={Close} className="w-[15px] h-[15px]"/>
				...
				<div className="w-full h-[90%] overflow-auto">
					...
					<div className='flex flex-col gap-4 w-[80%] lg:mx-16 mx-6 lg:my-8 my-4'>
						...
						<div>
							The index server is additional responsible for load balencing, which means that when a request to the server is made to download a piece of content. If multiple peers contain that content then the peer with the current least amount of downloads will be the address location that is sent to fulfill the request. As well, a peer should be able to when requed to quit will deregister all of its content from the server.
						</div>
